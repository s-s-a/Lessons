...
=======
FromDate = (datetime.now() + timedelta(days=-7)).strftime("%Y-%m-%d") # "2025-04-11"
ToDate   = (datetime.now() + timedelta(days= 1)).strftime("%Y-%m-%d")  # "2024-07-02"
>>>>>>> 5c39f649394f144af54e86d1663d6d480dab1841
...
=======
	...
	body = xmltodict.parse(response)["soap:Envelope"]["soap:Body"][ # type: ignore
		"GetCursDynamicXMLResponse"
	]["GetCursDynamicXMLResult"]["ValuteData"]["ValuteCursDynamic"]
